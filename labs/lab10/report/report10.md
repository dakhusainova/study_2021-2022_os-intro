...
![Командный код](image/1.jpg){ #fig:001 width=70% }
...
![Проверка работы файла](image/5.jpg){ #fig:005 width=70% }
...
![Пишем команды](image/7.jpg){ #fig:007 width=70% }
...
![Создание файла для 4 скрипта](image/10.jpg){ #fig:010 width=70% }
